...
export default defineNuxtConfig({
  ...
  app: {
    head: {
      ...
      meta: [
        { name: 'description', content: 'Website resmi SMAN 5 Taruna Brawijaya Jawa Timur - Berkarakter, Berprestasi, Mengabdi untuk Negeri' },
        { name: 'theme-color', content: '#042f1d' },
        { property: 'og:title', content: 'SMAN 5 Taruna Brawijaya Jawa Timur' },
        { property: 'og:description', content: 'Website resmi SMAN 5 Taruna Brawijaya Jawa Timur - Berkarakter, Berprestasi, Mengabdi untuk Negeri' },
